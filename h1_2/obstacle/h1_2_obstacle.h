...
#ifndef MJPC_TASKS_H1_2_obstacle
#define MJPC_TASKS_H1_2_obstacle
...
class H1_2_obstacle_Task : public Task {
 public:
  class ResidualFn : public mjpc::BaseResidualFn {
   public:
    explicit ResidualFn(const H1_2_obstacle_Task* task) : mjpc::BaseResidualFn(task) {}
...
void Residual(const mjModel* model, const mjData* data,
  ...
  H1_2_obstacle_Task() : residual_(this) {}
