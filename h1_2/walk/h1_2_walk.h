...
#ifndef MJPC_TASKS_H1_2
#define MJPC_TASKS_H1_2
...
class H1_2_walk : public Task {
 public:
  class ResidualFn : public mjpc::BaseResidualFn {
   public:
    explicit ResidualFn(const H1_2_walk* task) : mjpc::BaseResidualFn(task) {}
